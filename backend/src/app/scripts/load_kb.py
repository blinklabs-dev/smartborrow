...
# Since this script is now part of the 'app' package, we use relative imports
from ..core.database import SessionLocal, engine, Base
from ..models.optimization_check import OptimizationCheck
...
def load_knowledge_base(db: Session = None):
    """
    Loads optimization checks into the database.
    If db session is provided, it uses it. Otherwise, it creates a new one.
    """
